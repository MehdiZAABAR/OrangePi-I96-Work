...
PORTA_GPIO_MASK=0x7e50ae5c  # rda gpioA 15,20,22,25-30 (i96 gpio group)
...
#PORTA_SF_MASK=0xffffbfa0  # clear bits A 0-4,6,9-11,13,14 (i96 i2c, spi, i2s)
PORTA_SF_MASK=0xffffbefc  # clear bits A 0-4,6,9-11,13,14 (i96 i2c, spi, i2s)
